...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Te amo, no se como pude personalizar todo esto, pero es para ti corazón. Por ser un gran apoyo y por siempre esforzarte, nunca te rindas mi amor.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con cariño, Arely <3";
